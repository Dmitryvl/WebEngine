...
namespace WebEngine.Core.Static
{
	public static class QueryStrings
	{
		...
		public static string ProductsWithoutProperties = "SELECT p.Id, p.Name, p.ShortInfo, c.Name as CategoryName, com.Name as CompanyName FROM Products as p INNER JOIN Categories as c on p.CategoryId = c.Id INNER JOIN Companies as com on p.CompanyId = com.Id";
